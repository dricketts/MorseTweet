...
{ 
	...
	// Right now it only contains a text field for multiple keywords
    ...
    public class MorseTweets extends Sprite
    {
		...
		private var lightController:MorseWebcamLight;
		...
		public function MorseTweets() {
			...
			tweetStream.addStreamListener(handleNewTweet);
			lightController  = new MorseWebcamLight();
		}
		...
		// The callback for tweets
		private function handleNewTweet(tweet:Tweet) {
			 lightController.displayString(tweet.getTweetText());
		}
